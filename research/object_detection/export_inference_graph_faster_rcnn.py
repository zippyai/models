...
r"""Tool to export an Faster RCNN object detection model for inference.
...
python export_inference_graph \
    ...
    --pipeline_config_path path/to/faster_rcnn_coco.config \
...
def main(_):
  ...
  exporter.export_inference_graph_faster_rcnn(
